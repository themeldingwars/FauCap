...
namespace FauCap
{
    public class GameMessage : Message
    {
        ...
        public Channel Channel => Packets[0].Channel;
        public bool IsSplit => Packets[0].IsSplit;
        public bool IsReliable => Packets[0].IsReliable;
        public bool IsSequenced => Packets[0].IsSequenced;
